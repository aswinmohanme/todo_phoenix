defmodule Tasker.TodoListTest do
  use Tasker.DataCase

  alias Tasker.TodoList

  describe "todos" do
    alias Tasker.TodoList.Todo

    @valid_attrs %{description: "some description", is_complete: true, title: "some title"}
    @update_attrs %{description: "some updated description", is_complete: false, title: "some updated title"}
    @invalid_attrs %{description: nil, is_complete: nil, title: nil}
